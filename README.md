...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    match /users/{userId} {
      ...
      // Allow any authenticated user to view the list of users.
...
A user to manage their own data.
Any logged-in user to view the list of users for the community page.
Any logged-in user to read and write to the shared contest data.
